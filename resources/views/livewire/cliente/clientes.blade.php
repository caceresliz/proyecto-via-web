                    ...
                    <table class="table table-bordered table-striped mt-1">
                        ...
                        @foreach ($clientes as $cliente)
                            <tr>
                                ...
                                <td><h6>{{$cliente->apellidos}}</h6></td>
                                <td><h6>{{$cliente->ci}}</h6></td>
                                <td><h6>{{$cliente->correo}}</h6></td>
                                <td>
                                    <a href="javascript:void(0)" class="btn btn-dark mtmobile" title="Editar" wire:click="Edit({{$cliente->id}})">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg>
                                    </a>
                                    <a href="javascript:void(0)" class="btn btn-dark" title="Eliminar" onclick="Confirm('{{$cliente->id}}')">
